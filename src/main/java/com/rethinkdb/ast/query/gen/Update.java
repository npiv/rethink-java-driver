...
public class Update extends RqlQuery {
    ...
    public Update(List<Object> args, java.util.Map<String, Object> optionalArgs) {
        this(null, args, optionalArgs);
    }

    public Update(RqlQuery prev, List<Object> args, Map<String, Object> optionalArgs) {
        super(prev, Q2L.Term.TermType.UPDATE, args, optionalArgs);
    }
